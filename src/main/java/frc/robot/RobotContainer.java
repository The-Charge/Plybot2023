...
public class RobotContainer {
  ...
  private RobotContainer() {
    ...
    SmartDashboard.putData("DriveClaw", new DriveClaw(m_claw));
    ...
    m_claw.setDefaultCommand(new DriveClaw(m_claw));
  ...
  private void configureButtonBindings() {
    ...
    // Create some buttons
    final JoystickButton closeClawButton = new JoystickButton(leftJoystick, 11);
    closeClawButton.onTrue(new closeClaw(m_claw).withInterruptBehavior(InterruptionBehavior.kCancelSelf));

    final JoystickButton openClawButton = new JoystickButton(leftJoystick, 9);
