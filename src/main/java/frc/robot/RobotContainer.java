...
// The robot's subsystems
    ...
    public final PoseEstimator poseEstimator = new PoseEstimator(m_driveTrain, m_Camera);
  ...
  private RobotContainer() {
    ...
    SmartDashboard.putNumber("Ang P", Constants.ANGULAR_P);
  ...
  private void configureButtonBindings() {
    ...
    // Create some buttons
    JoystickButton tagAlignMidBtn = new JoystickButton(leftJoystick, 1);
    tagAlignMidBtn.onTrue(new TagAlign(m_driveTrain, m_Camera, 0));
     
    JoystickButton tagAlignLeftBtn = new JoystickButton(leftJoystick, 7);
    tagAlignMidBtn.onTrue(new TagAlign(m_driveTrain, m_Camera, -1));

    JoystickButton tagAlignRightBtn = new JoystickButton(leftJoystick, 8);
    tagAlignMidBtn.onTrue(new TagAlign(m_driveTrain, m_Camera, 1));    
    ...
    final JoystickButton changePipelineIndexBtn = new JoystickButton(rightJoystick, 12);
    changePipelineIndexBtn.onTrue(new ChangePipeline(m_Camera));
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=BUTTONS

    final JoystickButton tapeAlignButton = new JoystickButton(rightJoystick, 1);
    tapeAlignButton.whileTrue(new SequentialCommandGroup(new TapeAlign(m_driveTrain, m_Camera).andThen(() -> m_driveTrain.setCoast())));
  }
