...
public class RobotContainer {
  ...
  private RobotContainer() {
    ...
    SmartDashboard.putData("TurnNDegreesRelative", new TurnNDegreesRelative(180, m_driveTrain));
  ...
  private void configureButtonBindings() {
    ...
    // Create some buttons
    final JoystickButton turn90 = new JoystickButton(leftJoystick, 5);
    turn90.onTrue(new TurnNDegreesRelative(90, m_driveTrain).withInterruptBehavior(InterruptionBehavior.kCancelSelf));

    final JoystickButton turn180 = new JoystickButton(leftJoystick, 3);
    turn180.onTrue(new TurnNDegreesRelative(180, m_driveTrain).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
